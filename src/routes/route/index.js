...
import { WhiteSpace, Icon,List,Flex ,Tabs, Badge ,Tag} from 'antd-mobile'
import SearchHeader from 'components/searchheader'
import {routerRedux} from 'dva/router';
import styles from './index.less'


const Item = List.Item,Brief = Item.Brief,TabPane = Tabs.TabPane
const PrefixCls = 'route'
  ...
  return (
    <div>
      ...
      <Tabs defaultActiveKey="1" >
        <TabPane tab={<Badge>全部求助</Badge>} key="1">
            {messages.map(message => getCard(message,dispatch))}
        </TabPane>
        <TabPane tab={<Badge>我的求助</Badge>} key="2">

          我的求助

        </TabPane>
        <TabPane tab={<Badge>收藏的求助</Badge>} key="3">
          收藏的求助
        </TabPane>
      </Tabs>
      <WhiteSpace />
