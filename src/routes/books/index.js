...
import { Tabs,Badge,WhiteSpace,Grid,List,Icon} from 'antd-mobile';
...
{/*        <div className={styles[`${PrefixCls}-outer-title`]}> 我的阿拉善</div>
        <WhiteSpace size="md"/>*/}
        <div>
          <Tabs defaultActiveKey="1" onChange={handleClick} >
            <TabPane tab={<Badge >便民缴费</Badge>} key="1">
            </TabPane>
            <TabPane tab={<Badge >家政服务</Badge>} key="home">
            </TabPane>
            <TabPane tab={<Badge>汽车订票</Badge>} key="car">
            </TabPane>
            <TabPane tab={<Badge>预约挂号</Badge>} key="order">
            </TabPane>
          </Tabs>
