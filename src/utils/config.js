module.exports = {
  ...
  api: {
    ...
    QueryColumnTypeApi: '/cphsc/interface/huoqufenleiToTemporary.jcp',
    LoginApi: '/login/login.jcp',
    userLogout: '/login/appLogout.jcp',
    DetailsApi: '/cphsc/interface/getGaoJianInfo.jcp',
    DashboardApi: '/cphsc/interface/getHomeMenuInfoToTemporary.jcp',
    ...
    submitSurveyApi: '/cphsc/interface/surveyPanel.jcp',
    ...
    GetFairListApi: '/ExternalItems/fazhi/interface/getUserGongZhengYuYueList.jcp',
    UpdateFairApi: '/ExternalItems/fazhi/interface/updategongzhengyuyue.jcp',
    GetMyLawyerApi: '/ExternalItems/fazhi/interface/getUserFaLvYuanZhuList.jcp',
    GetMediateApi: '/ExternalItems/fazhi/interface/getUserRenMinTiaoJieList.jcp',
    UpdateMediateApi: '/ExternalItems/fazhi/interface/updateTiaoJie.jcp',
    SubmitSurveyInfoApi: '/cphsc/interface/condition/submitCondition.jcp',
