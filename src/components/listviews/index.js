...
class Results extends React.Component {
  ...
  componentDidMount () {
    ...
    this.lv.getInnerViewNode()
      .addEventListener('touchstart', this.ts = (e) => {
        this.tsPageY = e.touches[0].pageY;
      });
    this.lv.getInnerViewNode()
      .addEventListener('touchmove', this.tm = (e) => {
  ...
  componentWillUnmount () {
    this.lv.getInnerViewNode()
      .removeEventListener('touchstart', this.ts);
    this.lv.getInnerViewNode()
      .removeEventListener('touchmove', this.tm);
  ...
  render () {
    const separator = (sectionID, rowID) => (
      <div key={`${sectionID}-${rowID}`} id={`${sectionID}-${rowID}`} style={{
